...
export default {
    data: () => ({ Calculator: getRoute(Calculator), Configure: getRoute(Configure) }),
    computed: {
        activeRoute() {
    ...
    <div class="navbar-expand-md">
        <div class="collapse navbar-collapse" id="navbar-menu">
          <div class="navbar navbar-light">
            <div class="container-xl">
              <ul class="navbar-nav">
                <li class="nav-item" :class="{ active: activeHash === Calculator }">
              ...
              <div class="my-2 my-md-0 flex-grow-1 flex-md-grow-0 order-first order-md-last">
                <a class="btn btn-icon" :href="Configure">
